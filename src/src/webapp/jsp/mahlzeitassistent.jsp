	...
	<div class="main-container">
		<div class="main wrapper clearfix">
			<article>
				...
				<p>Klicken Sie auf ein Tellerdrittel, um ein Lebensmittel auszuwählen oder zu ändern.
					<br> Sie können zwischen dem Kategorienassisten und dem Nährstoffassistenten wählen.
					<br> Es werden nur Lebensmittel angezeigt, welche als gut oder mittel verträglich eingestuft wurden.
				</p>
				...
				<div class='my-legend'>
					...
					<div class='legend-scale'>
						<ul class='legend-labels'>
							<li>
								<span style='background:#FF7F7F;'></span>Fleisch</li>
							<li>
								<span style='background:#3EAC33;'></span>Obst</li>
							<li>
								<span style='background:#00933A;'></span>Gemüse</li>
							<li>
								<span style='background:#FEC576;'></span>Hülsenfrüchte</li>
							<li>
								<span style='background:#D1B89B;'></span>Nüsse und Samen</li>
							<li>
								<span style='background:#BFD1E0;'></span>Fisch</li>
							<li>
								<span style='background:#A2D3FF;'></span>Milch und Milchprodukte</li>
						</ul>
					</div>
				</div>
				<div class='my-legend'>
					...
					<div class='legend-scale'>
						<ul class='legend-labels'>
							<li>
								<span style='background:#FFEBE4;'></span>Proteine</li>
							<li>
								<span style='background:#E8E9FF;'></span>Stärkebeilage</li>
							<li>
								<span style='background:#E4FFF2;'></span>Vitamine</li>
						</ul>
					</div>
				</div>
			</aside>
