...
<style>
table.table_lebensmittelkategorie {
	display: <%out.println(request.getParameter("displaytable"));%>;
}
</style>
</head>
<body>
...
<![endif]-->
	<div class="header-container">
		...
		<span class="title">Fruechte&nbsp;<span class="arrowdown">&#9662;</span></span>
		<div id="mySidenav" class="sidenav side-nav">
			...
			<a class="active"
				href="${pageContext.request.contextPath}/lebensmittelsuche/">Suche</a>
			<a href="${pageContext.request.contextPath}/faq/">FAQ</a>
		</div>
		</nav> <a class="suchicon"
			href="${pageContext.request.contextPath}/suchfilter/">&#8981;</a> </header>
	</div>
		...
		<div class="main wrapper clearfix">
			...
			<form method="get"
				...
				<div>
					...
					<p></p>
					<input type="text" name="sucheintrag" value="" /> <input
					...
					<%
						...
						Lebensmitteldaten resultat = null;
						String lebensmittelname = "StringThatsNotInTheDB";
						Lebensmittelsuche lebensmittelsuche = new Lebensmittelsuche();
						if (request.getParameter("sucheintrag") == null) {
							...
							try {
								resultat = lebensmittelsuche.getLebensmittelInfoByName(lebensmittelname);
					%>
					<table class="table_lebensmittelkategorie">
						...
						<tr>
							<td>
								<%
									out.println(resultat.getLname());
								%>
							</td>
							<td>
								<%
									out.println(resultat.getKarenzphase());
								%>
							</td>
							<td>
								<%
									out.println(resultat.getDauerernaehrung());
										} catch (Exception ex) {
