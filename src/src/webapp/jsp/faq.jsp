            ...
            <article>
                ...
                <header>
                    ...
                    <div id="text1" style="display: none">
                        <% out.println(faq.getQuestionOrAnswer(1).getAnswer()); %>
                    </div>
                ...
                <section>
                    ...
                    <div id="text2" style="display: none">
                        <% out.println(faq.getQuestionOrAnswer(2).getAnswer()); %>
                    </div>
                ...
                <section>
                    ...
                    <div id="text3" style="display: none">
                        <% out.println(faq.getQuestionOrAnswer(3).getAnswer()); %>
                    </div>
                ...
                <section>
                    ...
                    <div id="text4" style="display: none">
                        <% out.println(faq.getQuestionOrAnswer(4).getAnswer()); %>
                    </div>
                ...
                <section>
                    ...
                    <div id="text5" style="display: none">
                        <% out.println(faq.getQuestionOrAnswer(5).getAnswer()); %>
                    </div>
                    <a class="resp-sharing-button__link" onclick="text5.style.display='block';auf5.style.display='none';zu5.style.display='block'"
                        id="auf5" style="display: block" href="#neu5" aria-label="">
                        <div class="resp-sharing-button resp-sharing-button--faq resp-sharing-button--small">
                            <div aria-hidden="true" class="resp-sharing-button__icon resp-sharing-button__icon--solid">
                                Show
                            </div>
                    ...
                    <a class="resp-sharing-button__link" onclick="text5.style.display='none';auf5.style.display='block';zu5.style.display='none'"
                        id="zu5" style="display: none" href="#neu5" aria-label="">
                        <div class="resp-sharing-button resp-sharing-button--faq resp-sharing-button--small">
                            <div aria-hidden="true" class="resp-sharing-button__icon resp-sharing-button__icon--solid">
                                Hide
                            </div>
