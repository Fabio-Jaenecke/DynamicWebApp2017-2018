                        ...
                        <header>
                           <h2>Diagnose der Histamin-Intoleranz</h2>
                       		...
                       		<article style="min-width: 100%">
								...
								Es gibt mittlerweile eine Leitlinie die von führenden Fachorganisationen empfohlen wird. Wichtig ist, keine Selbstdiagnosen zu machen, sondern immer im Dialog mit dem Arzt zu einer Diagnose zu kommen. Folgender Diagnoseweg gilt aktüll als Gold-Standard:
								...
								Das heißt Messungen der DAO oder des Histamins über den Urin oder den Stuhl haben sich als nicht aussagekräftig erwiesen. Damit bleibt, nach aktüllem Stand, nur eine rein klinische Diagnose (siehe oben) für die Histaminintoleranz übrig, da es (noch) keine verlässlichen Laborparameter gibt.
