                        ...
                        <header>
                           <h2>Diagnose der Histamin-Intoleranz</h2>
                       		...
                       		<article style="min-width: 100%">
								...
								<strong>Diaminoxidase (DAO)</strong> ist ein Enzym, welches unter anderem im Duenndarm produziert wird und ueber die Nahrung aufgenommenes Histamin abbaut. Fuer diesen Vorgang benoetigt die DAO unter anderem Vitamin B6 und Kupfer. DAO wird von gewissen Substanzen wie Alkohol oder anderen biogenen Aminen gehemmt. Histamin bildet sich ganz natuerlich durch Bakterien, d.h. Nahrung die lange gelagert wird enthält mehr Histamin, als frische Nahrung. Auch die Darmbakterien produzieren Histamin und andere biogene Amine. Daher benoetigt unser Koerper dieses Enzym im Darm, um das aufgenommene und im Darm produzierte Histamin abzubauen.
								...
								Während du ein Symptomtagebuch fuehrst, solltest du dich normal ernähren und keine Diät halten oder ploetzlich auf bestimmte Produkte verzichten. Dein Arzt muss sich Zeit fuer dich nehmen und ein sehr intensives Gespräch mit dir fuehren. Am besten ist es, wenn du dein Ernährungs- / Symptomtagebuch mitbringst. Vermerke im Tagebuch auch den Menstruationszyklus, sowie jede Einnahme von Medikamenten! Vermerke auch die Symptome die du hast.
								
								Dein Arzt wird versuchen mittels Differenzialdiagnose andere Erkrankungen auszuschließen. Hierzu gehoeren zum Beispiel Allergien, Mastozytose, chronisch entzuendliche Darmerkrankungen oder andere Unverträglichkeiten. Differnzialdiagnose heißt, dass man zuerst andere Erkrankungen mit sehr ähnlichen Symptomen, ausschließt. Allergien z.Bsp. ueber Prick- und RAST-Test, intestinale Fruktoseintoleranz oder Laktoseintoleranz ueber H2-Atemtest. Es gibt noch einige andere Erkrankungen, zum Beispiel die sehr seltene Mastozytose, die man zuerst ausschließen sollte.
								
								<h4>Zweiter Schritt: Eliminationsdiät mit oder ohne Provokationstest</h4>
								Da man fuer diesen Diagnoseweg eine genaue Kenntnis ueber den Histamingehalt und die Histaminkarenz benoetigt, ist dieser Diagnoseweg sehr schwierig und muss ernährungstherapeutisch begleitet werden!
								...
								Achtung: Es gibt am Markt noch Blutheimtests oder andere Tests fuer zu Hause zur Histaminintoleranz-Diagnostik. Auch einige ärzte machen noch Bluttests zur Bestimmung der DAO. Diese Tests werden aber von den Fachoprganisationen und aus den dargelegten Gruenden als nicht geeignet eingestuft und koennen Fehldiagnosen liefern.
								
								<h4>Diagnoseweg: Laborparameter "Blut"</h4>
								blutabnahme bei histaminintoleranz; (C) Michäl Zechmann / nmi-PortalDa wir ja die Enzyme DAO und HNMT zum Abbau haben, koennte man vermuten, dass die Menge der Enzyme im Blut als Diagnoseverfahren herangezogen werden koennte. Das funktioniert aber leider nicht. Man hat auch versucht die Aktivität der DAO, also nicht die Menge, als Diagnose-Faktor zu etablieren. Ebenfalls mit mäßigem Erfolg. Man hat nämlich festgestellt, dass die Aktivität der Enzyme in der Duenndarmschleimhaut nicht mit der Menge oder Aktivität im Blut zusammenhängt.
								...
								Man kann auch die Histamin und Methylhistamin Konzentration im Harn bestimmen. Mehylhistamin ist das Abbauprodukt der HNMT. Liegt ein DAO-Mangel vor, wird das Histamin vermehrt in den Zellen ueber die HNMT abgebaut. Entsprechend erhoeht sich das Abbauprodukt Methylhistamin, welches ueber den Harn ausgeschieden wird und damit ueber einen 12-h-Sammelurintest von einem Labor bestimmt werden kann. Dann wird einige Tage lang eine strikte Kartoffel-Reis-Diät gehalten und der Urintest wiederholt. Aus der änderung der Ergebnisse dachte man, koennte man auf eine HIT schließen. Das hat sich als nicht richtig herausgestellt. Auch hier ist nämlich eine Differentialdiagnose wichtig, da dieser Test alleine nicht aussagekräftig genug ist, um eine Histaminintoleranz zu diagnostizieren. 5)
								
								Auch im Stuhl kann die Histaminmenge bestimmt werden. Diese Menge zeigt jedoch nur an, wieviel Histamin nicht im Darm abgebaut wurde. Diese Menge variiert je nach dem, was man zuvor gegessen hat, also je nachdem wie hoch die zugefuehrte Histaminmenge war, und je nachdem wie die Bakterienzusammensetzung im Darm ist. Das vom Koerper selbst produzierte Histamin kann dieser Test nicht beruecksichtigen. Dieser Test galt schon länger als unsicher und zählt daher zu den veralteten Diagnosewegen. 5)
