                        ...
                        <header>
                           <h2>Diagnose der Histamin-Intoleranz</h2>
                       		...
                       		<article style="min-width: 100%">
								...
								<strong>Diaminoxidase (DAO)</strong> ist ein Enzym, welches unter anderem im Duenndarm produziert wird und ueber die Nahrung aufgenommenes Histamin abbaut. Fuer diesen Vorgang benötigt die DAO unter anderem Vitamin B6 und Kupfer. DAO wird von gewissen Substanzen wie Alkohol oder anderen biogenen Aminen gehemmt. Histamin bildet sich ganz natuerlich durch Bakterien, d.h. Nahrung die lange gelagert wird enthält mehr Histamin, als frische Nahrung. Auch die Darmbakterien produzieren Histamin und andere biogene Amine. Daher benötigt unser Körper dieses Enzym im Darm, um das aufgenommene und im Darm produzierte Histamin abzubauen.
								...
								Unser Symptom-Tagebuch ist auch als App fuer Android Geräte verfuegbar.
								
								Wir haben auch einen Vordruck fuer ein Symptomtagebuch zum kostenlosen Download:
								
								
								Symptomtagebuch zum Ausdrucken (A4)
								Während du ein Symptomtagebuch fuehrst, solltest du dich normal ernähren und keine Diät halten oder plötzlich auf bestimmte Produkte verzichten. Dein Arzt muss sich Zeit fuer dich nehmen und ein sehr intensives Gespräch mit dir fuehren. Am besten ist es, wenn du dein Ernährungs- / Symptomtagebuch mitbringst. Vermerke im Tagebuch auch den Menstruationszyklus, sowie jede Einnahme von Medikamenten! Vermerke auch die Symptome die du hast.
								
								Dein Arzt wird versuchen mittels Differenzialdiagnose andere Erkrankungen auszuschließen. Hierzu gehören zum Beispiel Allergien, Mastozytose, chronisch entzuendliche Darmerkrankungen oder andere Unverträglichkeiten. Differnzialdiagnose heißt, dass man zuerst andere Erkrankungen mit sehr ähnlichen Symptomen, ausschließt. Allergien z.Bsp. ueber Prick- und RAST-Test, intestinale Fruktoseintoleranz oder Laktoseintoleranz ueber H2-Atemtest. Es gibt noch einige andere Erkrankungen, zum Beispiel die sehr seltene Mastozytose, die man zuerst ausschließen sollte.
								
								<h4>Zweiter Schritt: Eliminationsdiät mit oder ohne Provokationstest</h4>
								Da man fuer diesen Diagnoseweg eine genaue Kenntnis ueber den Histamingehalt und die Histaminkarenz benötigt, ist dieser Diagnoseweg sehr schwierig und muss ernährungstherapeutisch begleitet werden!
								...
								Achtung: Es gibt am Markt noch Blutheimtests oder andere Tests fuer zu Hause zur Histaminintoleranz-Diagnostik. Auch einige ärzte machen noch Bluttests zur Bestimmung der DAO. Diese Tests werden aber von den Fachoprganisationen und aus den dargelegten Gruenden als nicht geeignet eingestuft und können Fehldiagnosen liefern.
								
								<h4>Diagnoseweg: Laborparameter "Blut"</h4>
								blutabnahme bei histaminintoleranz; (C) Michäl Zechmann / nmi-PortalDa wir ja die Enzyme DAO und HNMT zum Abbau haben, könnte man vermuten, dass die Menge der Enzyme im Blut als Diagnoseverfahren herangezogen werden könnte. Das funktioniert aber leider nicht. Man hat auch versucht die Aktivität der DAO, also nicht die Menge, als Diagnose-Faktor zu etablieren. Ebenfalls mit mäßigem Erfolg. Man hat nämlich festgestellt, dass die Aktivität der Enzyme in der Duenndarmschleimhaut nicht mit der Menge oder Aktivität im Blut zusammenhängt.
								
								<h4>Diagnoseweg: Duenndarmbiopsie DAO-Aktivität</h4>
								Alternativ kann ueber eine Duenndarmbiopsie mittels eines ELISA (enzyme-linked immunosorbent assay) die Aktivität bestimmt werden. Letzteres bietet sich an, wenn sowieso schon eine Duenndarmbiopsie durchgefuehrt wird. Daher ist diese Methode keine uebliche Diagnosemethode.
								
								Die Interpretation der DAO-Aktivität muss jedoch auch hier im Kontext mit der Klinik und der Anamnese durchgefuehrt werden, das heißt der oben beschriebene Gold-Standard muss sowieso beschritten werden.
								
								<h4>Diagnoseweg: Laborparameter "Urin" und "Stuhl"</h4>
								Man kann auch die Histamin und Methylhistamin Konzentration im Harn bestimmen. Mehylhistamin ist das Abbauprodukt der HNMT. Liegt ein DAO-Mangel vor, wird das Histamin vermehrt in den Zellen ueber die HNMT abgebaut. Entsprechend erhöht sich das Abbauprodukt Methylhistamin, welches ueber den Harn ausgeschieden wird und damit ueber einen 12-h-Sammelurintest von einem Labor bestimmt werden kann. Dann wird einige Tage lang eine strikte Kartoffel-Reis-Diät gehalten und der Urintest wiederholt. Aus der änderung der Ergebnisse dachte man, könnte man auf eine HIT schließen. Das hat sich als nicht richtig herausgestellt. Auch hier ist nämlich eine Differentialdiagnose wichtig, da dieser Test alleine nicht aussagekräftig genug ist, um eine Histaminintoleranz zu diagnostizieren. 5)
								
								Auch im Stuhl kann die Histaminmenge bestimmt werden. Diese Menge zeigt jedoch nur an, wieviel Histamin nicht im Darm abgebaut wurde. Diese Menge variiert je nach dem, was man zuvor gegessen hat, also je nachdem wie hoch die zugefuehrte Histaminmenge war, und je nachdem wie die Bakterienzusammensetzung im Darm ist. Das vom Körper selbst produzierte Histamin kann dieser Test nicht beruecksichtigen. Dieser Test galt schon länger als unsicher und zählt daher zu den veralteten Diagnosewegen. 5)
								
								Das heißt Messungen der DAO oder des Histamins ueber den Urin oder den Stuhl haben sich als nicht aussagekräftig erwiesen. Damit bleibt, nach aktuellem Stand, nur eine rein klinische Diagnose (siehe oben) fuer die Histaminintoleranz uebrig, da es (noch) keine verlässlichen Laborparameter gibt.
								
								<h3>Andere Diagnoseverfahren wie IgG Test, Auspendeln, Bioresonanz oder Speicheltests</h3>
								Der IgG Test mißt die Immunreaktion des körpereigenen Immunglobulin G. Diese Tests sind definitiv nicht geeignet, Laktoseintoleranz, Fructosemalabsorption oder Histaminintoleranz nachzuweisen! Infos dazu hier...  Auch andere am Markt angebotene Tests sind als unseriös einzustufen. Es gibt fuer die meisten dieser Tests, auch wenn sie sehr wissenschaftlich klingen und die Hersteller mit Positiv-Beispielen werben, keine Studien oder Evaluationen.
								                       		</article>
                        </header>
