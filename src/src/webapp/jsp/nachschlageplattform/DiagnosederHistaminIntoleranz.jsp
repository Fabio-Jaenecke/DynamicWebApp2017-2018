                        ...
                        <header>
                           <h2>Diagnose der Histamin-Intoleranz</h2>
                       		...
                       		<article style="min-width: 100%">
								...
								<strong>Diaminoxidase (DAO)</strong> ist ein Enzym, welches unter anderem im Dünndarm produziert wird und über die Nahrung aufgenommenes Histamin abbaut. Für diesen Vorgang benoetigt die DAO unter anderem Vitamin B6 und Kupfer. DAO wird von gewissen Substanzen wie Alkohol oder anderen biogenen Aminen gehemmt. Histamin bildet sich ganz natürlich durch Bakterien, d.h. Nahrung die lange gelagert wird enthält mehr Histamin, als frische Nahrung. Auch die Darmbakterien produzieren Histamin und andere biogene Amine. Daher benoetigt unser Koerper dieses Enzym im Darm, um das aufgenommene und im Darm produzierte Histamin abzubauen.
								...
								Während du ein Symptomtagebuch führst, solltest du dich normal ernähren und keine Diät halten oder ploetzlich auf bestimmte Produkte verzichten. Dein Arzt muss sich Zeit für dich nehmen und ein sehr intensives Gespräch mit dir führen. Am besten ist es, wenn du dein Ernährungs- / Symptomtagebuch mitbringst. Vermerke im Tagebuch auch den Menstruationszyklus, sowie jede Einnahme von Medikamenten! Vermerke auch die Symptome die du hast.
								
								Dein Arzt wird versuchen mittels Differenzialdiagnose andere Erkrankungen auszuschließen. Hierzu gehoeren zum Beispiel Allergien, Mastozytose, chronisch entzündliche Darmerkrankungen oder andere Unverträglichkeiten. Differnzialdiagnose heißt, dass man zuerst andere Erkrankungen mit sehr ähnlichen Symptomen, ausschließt. Allergien z.Bsp. über Prick- und RAST-Test, intestinale Fruktoseintoleranz oder Laktoseintoleranz über H2-Atemtest. Es gibt noch einige andere Erkrankungen, zum Beispiel die sehr seltene Mastozytose, die man zuerst ausschließen sollte.
								
								<h4>Zweiter Schritt: Eliminationsdiät mit oder ohne Provokationstest</h4>
								Da man für diesen Diagnoseweg eine genaue Kenntnis über den Histamingehalt und die Histaminkarenz benoetigt, ist dieser Diagnoseweg sehr schwierig und muss ernährungstherapeutisch begleitet werden!
								...
								Achtung: Es gibt am Markt noch Blutheimtests oder andere Tests für zu Hause zur Histaminintoleranz-Diagnostik. Auch einige Ärzte machen noch Bluttests zur Bestimmung der DAO. Diese Tests werden aber von den Fachoprganisationen und aus den dargelegten Gründen als nicht geeignet eingestuft und koennen Fehldiagnosen liefern.
