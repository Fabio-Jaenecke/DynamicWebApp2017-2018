                  ...
                  <div class="main wrapper clearfix">
                     <article>
                        <header>
                           ...
                           <p>Histaminintoleranz (Histaminose, HistaminunvertrÃ¤glichkeit) ist die UnvertrÃ¤glichkeit von stark histaminhaltigen Nahrungsmitteln beziehungsweise die UnfÃ¤higkeit des menschlichen KÃ¶rpers, das aufgenommene Histamin in ausreichendem MaÃe abzubauen. In diesem Artikel gibt es einige Grundinformationen.
                           </p>
                           <a href="#">Mehr</a>
                        </header>
                        <section>
                           <h2>Histamingehalt von Lebensmitteln</h2>
                           <p>Welche Nahrungsmittel sind vertrÃ¤glich, welche sind bei Histaminintoleranz nicht vertrÃ¤glich? FÃ¼r Betroffene ist es schwer, einzukaufen.
                           </p>
                           <a href="#">Mehr</a>
                        </section>
                        <section>
                           <h2>Symptome der Histamin-Intoleranz</h2>
                           <p>Die Symptome der Histaminintoleranz sind sehr vielfÃ¤ltig und teilweise schwer von Symptomen anderer, hÃ¤ufigerer Krankheiten zu unterscheiden. Sie machen sich meist einige Minuten bis wenige Stunden nach dem Konsum histaminreicher beziehungsweise histaminfreisetzender oder DAO-blockierender Nahrungsmittel bemerkbar.
                           </p>
                           <a href="#">Mehr</a>
                        </section>
                        <section>
                           <h2>Diagnose der Histamin-Intoleranz</h2>
                           <p> Wir wird die Histaminintoleranz diagnostiziert? Was ist dabei zu beachten? Ein Leitfaden fÃ¼r Ãrzte und Betroffene.
                           </p>
                           <a href="#">Mehr</a>
                        </section>
                        <section>
                           <h2>Behandlung der Histamin-Intoleranz</h2>
                           <p> Wie kann man die Histaminintoleranz behandeln? Was kann man tun, welche Medikamente gibt es? Dieser Artikel klÃ¤rt dich Ã¼ber diese wichtigen Fragen auf.
                           </p>
                           <a href="#">Mehr</a>
                        </section>
                        <footer>
                           <h3>StÃ¶bern Sie weiter</h3>
                           <ul>
               ...
               <div class="footer-container">
                  <footer class="wrapper">
                     ...
                     <p> Â© 2017 PSIT1/2, WEB1, ZHAW<br>
                        Powered by: AndrÃ© Livramento (livraand), Raphael Caradonna (caradrap) , Marko Despotovic (despomar), Fabio Jaenecke (jaenefab) 
                     </p>
