...
/**
 * Diese Klasse uebergibt die Datenbankabfrage der Datenbank und fuehrt eine Suche mit einer vordefinierten Tabelle durch und gibt
 * die Lebensmittel in der entsprechenden Tabelle als Liste aus. Es stehen verschiede Methoden fuer Listenausegaben bereit.
 *
...
public class SucheListe extends SucheMultiTupel {
  ...
  public String naehrstoffSuche(String naehrstoffname) {
    String selectSQL = "SELECT * FROM lebensmittelDaten l JOIN NAEHRZUGEHOERIGKEIT n" + " ON l.lindex=n.lindex" + " WHERE n.nname='"
        + naehrstoffname + "';";
    return selectSQL;
  }
