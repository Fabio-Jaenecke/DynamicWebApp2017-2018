...
public class SearchresultTest {
	...
	/*
	 * tests if array of xmlSites in search result is correctly handled. 
	 * as only one html-site is searched through, array only contains one document
	 * */
	@Test
