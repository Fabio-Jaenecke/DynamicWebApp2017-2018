...
/**
 * Diese Klasse holt die lebensmittelDaten, die fuer die Rangliste benoetigt werden, aus der Datenbank und stellt diese zur
 * Verfuegung.
 * 
...
public class RanglistenManager {
  ...
  /**
   * Erzeugt die Rangliste f�r die Lebensmittelvertraeglichkeit.
   * 
