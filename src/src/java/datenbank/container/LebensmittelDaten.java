...
/**
 * stellt die Java-Klasse zur Entitaet lebensmittelDaten in der Datenbank da
 * 
...
public class LebensmittelDaten {
  ...
  public String toString() {
    return getLindex() + String.format(" ", getLname(), " ", getKarenzphase(), " ", getDauerernaehrung(), " ", getKategorie());
  }
